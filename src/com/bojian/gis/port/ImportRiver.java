...
public class ImportRiver extends Upload{
	private static final String TAG = "ImportRiver";
	...
	public ImportRiver(String username, String password, int city) {
	...
	protected String getUrl() {
		// TODO Auto-generated method stub
		return UrlLib.getImportRaiverUrl(username, password, city);
	}
